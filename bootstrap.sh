...
cd /opt
tar xvzf /home/downloads/hadoop-2.7.3.tar.gz
echo 'export HADOOP_HOME=/opt/hadoop-2.7.3;export PATH=$HADOOP_HOME/bin:$PATH' > /etc/profile.d/hadoop.sh
...
<!-- Put site-specific property overrides in this file. -->
 ...
 </configuration>' > /opt/hadoop-2.7.3/etc/hadoop/core-site.xml
...
</configuration>' > /opt/hadoop-2.7.3/etc/hadoop/hdfs-site.xml
...
' > /opt/hadoop-2.7.3/etc/hadoop/mapred-env.sh
...
' > /opt/hadoop-2.7.3/etc/hadoop/yarn-env.sh